...
*/ 
  inline void setMotorInvertedSpeedSign(bool value) { _motorInvertedSpeedSign = value; } //miniBloq.
  inline bool getMotorInvertedSpeedSign() const { return _motorInvertedSpeedSign; } //miniBloq.
...
private:   
  ...
  byte stepIndex[2];
  bool _motorInvertedSpeedSign; //miniBloq.
